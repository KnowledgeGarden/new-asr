...
CREATE UNIQUE INDEX IF NOT EXISTS inlinks_idx ON public.inlinks (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS outlinks_idx ON public.outlinks (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS synonym_idx ON public.synonym (id);

CREATE TABLE IF NOT EXISTS public.antonym (
  	id BIGINT PRIMARY KEY NOT NULL REFERENCES  public.words (id),
  	antonym	TEXT NOT NULL 
);
CREATE UNIQUE INDEX IF NOT EXISTS antonym_idx ON public.antonym (id);
